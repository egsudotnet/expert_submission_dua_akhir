...
void main() {
  ...
  group('get Now Playing Tvs', () {
    ...
    () async {
      ...
      // act
      final result = await dataSourceTv.getNowPlayingTvs(); 
      // assert
    ...
    test(
      ...
      // act
      final call = dataSourceTv.getNowPlayingTvs();
      // assert
  ...
  group('search movies', () {
    final tSearchResult = MovieResponse.fromJson(
            json.decode(readJson('dummy_data/movie_search.json')))
        .movieList;
    ...
    test('should return list of movies when response code is 200', () async {
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/movie_search.json'), 200));
      // act
