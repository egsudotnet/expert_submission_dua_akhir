...
class MockMovieTopRatedCubit extends _i1.Mock
  ...
  _i3.MovieTopRatedState get state => (super.noSuchMethod(
        ...
        returnValue: _FakeMovieTopRatedState_1(
          this,
          Invocation.getter(#state),
        ),
      ) as _i3.MovieTopRatedState);
  @override
  _i4.Stream<_i3.MovieTopRatedState> get stream => (super.noSuchMethod(
  ...
  @override
  void emit(_i3.MovieTopRatedState? state) => super.noSuchMethod(
        Invocation.method(
          #emit,
          [state],
        ),
